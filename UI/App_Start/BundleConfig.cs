...
namespace UI
{
	public class BundleConfig
	{
		...
		{
			bundles.Add(new ScriptBundle("~/bundles/layout").Include("~/js/jquery-{version}.js").Include("~/js/bootstrap.js").Include("~/js/tinynav.js").Include("~/js/template.js").Include("~/js/socialLinks.js").Include("~/js/jquery-cookie-plugin.js").Include("~/js/timezone.js").Include("~/js/jquery-ui.custom/jquery-ui.js"));
			...
			bundles.Add(new StyleBundle("~/bundles/css").Include("~/css/wisewords/magic-bootstrap.css").Include("~/css/wisewords/bootstrap.css").Include("~/css/wisewords/bootstrap-responsive.css").Include("~/css/wisewords/socialicons.css").Include("~/css/wisewords/glyphicons.css").Include("~/css/wisewords/halflings.css").Include("~/css/wisewords/template.css").Include("~/css/wisewords/colors/color-classic.css").Include("~/css/site.css").Include("~/css/adminLinks.css").Include("~/js/jquery-ui.custom/jquery-ui.css").Include("~/js/jquery-ui.custom/jquery-ui.structure.css").Include("~/js/jquery-ui.custom/jquery-ui.theme.css"));
